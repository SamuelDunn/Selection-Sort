/*
 This client program will test the mySelectionSort() function with a variety
 different input arrays and will compare the time-cost of using the selection
...
int main() {
   ...
   cout <<  "Time-cost using mySelectionSort() with 10000 element array:"
   << endl << endl;
   cout << fixed << setprecision(4);

   startClock = clock();
   mySelectionSort(orderedArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   ...
   startClock = clock();
   mySelectionSort(reverseOrderedArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   mySelectionSort(uniformArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   mySelectionSort(nearlyOrderedArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   mySelectionSort(orderedWithDuplicateElements, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
